 ...
 * @module KeysApi
 */
var keysApi = function keysApi(connection) {
  /**
  ...
  return {
    ...
    create: function create(params) {
      return connection.request('/create-key', params);
    },
    ...
    listAll: function listAll() {
      return connection.request('/list-keys');
    },
    ...
    delete: function _delete(params) {
      return connection.request('/delete-key', params);
    },
    ...
    checkPassword: function checkPassword(params) {
      return connection.request('/check-key-password', params);
    },
    ...
    resetPassword: function resetPassword(params) {
      return connection.request('/reset-key-password', params);
    }
  };
};
