 ...
 * @module AssetsApi
 */
var assetsApi = function assetsApi(connection) {
  ...
  return {
    ...
    create: function create(params) {
      return connection.request('/create-asset', params);
    },
    ...
    listAll: function listAll() {
      return connection.request('/list-assets', {});
    },
    ...
    list: function list(id) {
      return connection.request('/get-asset', { id: id });
    },
    ...
    updateAlias: function updateAlias(params) {
      return connection.request('/update-asset-alias', params);
    }
  };
};
