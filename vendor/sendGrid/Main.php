...
class Main
{
    ...
    public function __construct($apiKey, $options = array())
    {
        ...
        $this->client = new \vendor\SendGrid\Client(
            $host,
            $headers,
            '/v3',
            null,
     ...
     * Make an API request
     *
     * @param \vendor\SendGrid\Api $email A Mail object, containing the request object
     *
     * @return \vendor\SendGrid\Response
     */
    public function send(\vendor\SendGrid\Api $email)
    {
