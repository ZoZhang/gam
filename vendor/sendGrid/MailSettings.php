...
class MailSettings implements \JsonSerializable
{
    ...
    public function setBccSettings($enable, $email = null)
    {
        ...
        if (!is_bool($enable)) {
            throw new TypeException(
                '$enable must be an instance of vendor\SendGrid\BccSettings or of type bool.'
            );
        }
    ...
    public function setBypassListManagement($enable)
    {
        ...
        if (!is_bool($enable)) {
            throw new TypeException(
                '$enable must be an instance of vendor\SendGrid\BypassListManagement or of type bool.'
            );
        }
